...
import com.jeiko.shortlink_demo.project.dao.entity.LinkBrowserStatsDO;
...
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStatsDO> {
    ...
    List<HashMap<String, Object>> listBrowserStats(@Param("param") ShortLinkStatsReqDTO requestParam);
}

...
import static com.jeiko.shortlink_demo.admin.common.convention.errorcode.BaseErrorCode.USER_TOKEN_FAIL;
        ...
        if (!IGNORE_URI.contains(requestURI)) {
            ...
            if (!(Objects.equals(requestURI, "/api/short-link/admin/v1/user") && Objects.equals(method, "POST"))) {
                ...
                if (!StrUtil.isAllNotBlank(username, token)){
                    // 向客户端返回异常信息
                    returnJson((HttpServletResponse) servletResponse, JSON.toJSONString(ResultUtils.failure(new ClientException(USER_TOKEN_FAIL))));
                    return;
                }
